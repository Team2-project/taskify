...
export default function CreateDashBoard({
  ...
  return (
    <div className='fixed inset-0 box-border h-full w-full bg-black bg-opacity-50'>
      <div className='fixed inset-0 z-50 m-auto h-[293px] w-[327px] rounded-[8px] bg-white px-[20px] py-[28px] tablet:h-[334px] tablet:w-[540px]'>
        ...
        <Form onSubmit={(e) => onSubmit(e, selectedCircle)}>
          ...
          />
          <div className='mr-[107px] mt-[24px] flex justify-around gap-[10px] tablet:mr-[291px] tablet:mt-[32px] tablet:justify-around'>
            {colors.map((color) => (
              <div
                key={color}
          ...
          <div className='flex items-center justify-center gap-[11px] py-[20px] tablet:justify-end tablet:py-[10px]'>
            <Button
