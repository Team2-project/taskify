...
export default function Textarea({
  ...
  return (
    <div className='mt-[18px] flex flex-col gap-[10px] tablet:mt-[26px]'>
      ...
      <div className='relative flex h-[84px] tablet:h-[96px] w-full items-center rounded-[6px] border-[1px] border-gray-30 p-4 active:border-[1px] active:border-violet-20'>
        <textarea
